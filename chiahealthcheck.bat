@echo off
cls
echo [32mThis Chia Checker Tool Is Only For Chia Version 1.1.7[0m
echo [32mThe Chia Checker Tool For 1.1.6 Can Be Downloaded From Git Hub[0m
echo [32mCreated By Reddit User: Toaster Potato[0m [94m
pause [0m

cd %LocalAppData%\chia-blockchain\app-1.1.7\resources\app.asar.unpacked\daemon\
echo [32mMoving to working directory for chia version 1.1.7[0m
